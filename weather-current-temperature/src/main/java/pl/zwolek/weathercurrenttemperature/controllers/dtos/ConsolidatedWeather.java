...
import pl.zwolek.weathercurrenttemperature.enums.WeatherStatesType;
...
public class ConsolidatedWeather {
    ...
    public Double getMinTemp() {
        return Precision.round(minTemp, 2);
    }
    ...
    public Double getMaxTemp() {
        return Precision.round(maxTemp, 2);
    }
    ...
    public Double getTheTemp() {
        return Precision.round(theTemp, 2);
    }
    ...
    public String getIconUrl() {
        return WeatherStatesType.getUrlIconByAbbreviation(weatherStateAbbr);
    }
